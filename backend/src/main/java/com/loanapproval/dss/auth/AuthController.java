...
import com.loanapproval.dss.auth.dto.ResendVerificationRequest;
...
public class AuthController {
    ...
    public EmailVerificationResponse resendVerification(@Valid @RequestBody ResendVerificationRequest request) {
